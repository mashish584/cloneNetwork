...
var get    = require('../secure/smtpCred');
                ...
                */
                    ...
                    var mailOptions = {
                        ...
                        html     : `<h1>RESET PASSWORD</h1>
                                    <p>Your request for password reset is approved.Click <a href="https://testingmode.herokuapp.com/reset/${req.body.email}/${hash}">here</a> to activate.Valid for 30 minutes only.</p>
                                    `
                    };
